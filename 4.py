...
def about_page():
    ...
    # โหลดรูปภาพ about  
    try:
        # สมมติว่าไฟล์รูปภาพ 'about me.jpg' ถูกบันทึกไว้ในโฟลเดอร์เดียวกับโค้ด
        ...
        # เพิ่มปุ่ม 'ย้อนกลับ' บนรูปภาพ (ตำแหน่งอ้างอิงจากรูปภาพ)
        ...
        print("ไม่พบไฟล์รูปภาพ 'about me.jpg' กรุณาตรวจสอบให้แน่ใจว่าไฟล์อยู่ในโฟลเดอร์เดียวกัน")
...
def login_page():
    ...
    about_button = tk.Button(login_window, text="⋯", font=("Arial", 30, "bold"),
                             bg="#ffabcf", fg="#552c1f", bd=1, relief="ridge",
                             activebackground="#E3B2C3", command=about_page)
    # วางตำแหน่งด้านขวาด้านล่าง
    about_button.place(x=890, y=470, width=50, height=50)
...
def register_page():
    ...
    about_button = tk.Button(register_window, text="⋯", font=("Arial", 30, "bold"),
                             bg="#ffabcf", fg="#552c1f", bd=1, relief="ridge",
                             activebackground="#E3B2C3", command=about_page)
    # วางตำแหน่งด้านขวาด้านล่าง
    about_button.place(x=890, y=470, width=50, height=50)
...
about_button = tk.Button(root, text="•••", font=("Arial", 23 , "bold"),
                         bg="#ff88bd", fg="#552c1f", bd=0, relief="ridge",
                         activebackground="#E3B2C3", command=about_page)
# วางตำแหน่งด้านขวาด้านล่าง (x=960-50-20=890, y=470)
about_button.place(x=901, y=490, width=40, height=30)
